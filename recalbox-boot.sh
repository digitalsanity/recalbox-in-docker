...
docker run --privileged -it -v $HOME/recalbox-share:/recalbox/share -v /media:/media -v /mnt:/mnt -v /etc/machine-id:/etc/machine-id -v /dev:/dev recalbox/recalbox:master
